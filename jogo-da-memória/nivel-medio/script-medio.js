...
let attemptsLeft = 10; // Número de tentativas para o nível médio
...
function checkAllCardsMatched() {
    ...
    if (matchedCards.length === fullCardDeck.length) {
        document.querySelector('.result').innerHTML = 'Você conseguiu! Se prepare para o Difícil!';
...
function restartGame() {
    ...
    firstCard = null;
    secondCard = null;
    attemptsLeft = 10; // Número de tentativas para o nível médio
    // Cria novas cartas
    createCards();
}
