...
function reiniciarJogo() {
    ...
    tentativasRestantes = 25; // Define o número de tentativas
...
function verificarPalpite() {
    ...
    if (palpite == numeroAleatorio) {
        ...
        if (difference <= 3) {
            ...
            document.getElementById('resultado').innerText = 'Esta Pegando Fogo!';
